...
| **Sprint 6**<br>*(Seller Chat Linking, Real-time Status, Accessibility & Footer)* | **ระบบแชทตรงกับผู้ขาย, สถานะออนไลน์เรียลไทม์, ปรับขนาดฟอนต์ และเพิ่ม Footer ประวัติ SE Mini Project:**<br>• เชื่อมโยงปุ่มกด "ส่งข้อความแชท" จากหน้ารายละเอียดหนังสือไปยังผู้ขายคนนั้นโดยตรงและเปิดห้องแชทให้อัตโนมัติ<br>• เพิ่มระบบ Socket broadcast แสดงจุดและข้อความสถานะ `กำลังใช้งาน (Online)` / `ออฟไลน์ (Offline)` เรียลไทม์<br>• ขยายขนาดตัวอักษรหน้าลงขาย/แก้ไขหนังสือจาก `text-xs` (12px) เป็น `text-sm` (14px) เพื่อลดอาการปวดตา<br>• เพิ่มคอมโพเนนต์ `Footer` ระบุประวัติ SE Mini Project สมาชิก 3 คน (Nontprawitch, Chanidapha, Chaianun) และหมายเหตุการปรับปรุงด้วย AI | `Completed` | [DetailsPage.jsx](file:///c:/Users/Nontprawitch/Desktop/Vs%20code/Javascript/Book_University/client/src/pages/user/DetailsPage.jsx)<br>[ChatPage.jsx](file:///c:/Users/Nontprawitch/Desktop/Vs%20code/Javascript/Book_University/client/src/pages/user/ChatPage.jsx)<br>[Footer.jsx](file:///c:/Users/Nontprawitch/Desktop/Vs%20code/Javascript/Book_University/client/src/components/layouts/Footer.jsx) |
...
ในรอบการพัฒนานี้ เน้นการปรับปรุงประสบการณ์ผู้ใช้งาน (UX/UI Enhancement), การเชื่อมโยงการสื่อสารระหว่างผู้ซื้อและผู้ขายอย่างไร้รอยต่อ, การเพิ่มสถานะการออนไลน์แบบเรียลไทม์ผ่าน Socket.io, การปรับปรุงขนาดตัวอักษรเพื่อลดอาการปวดสายตาของผู้ใช้, และการเพิ่มส่วน Footer บันทึกประวัติโครงงาน:
...
#### 3. Typography & Form Accessibility Optimization (การปรับขนาดฟอนต์เพื่อการอ่านง่ายสบายตา)
*   **รายละเอียดฟีเจอร์:**
    *   แก้ไขปัญหาสายตาและความลำบากในการมองตัวอักษรขนาดเล็กในหน้าลงขายหนังสือ [AddBook.jsx](file:///c:/Users/Nontprawitch/Desktop/Vs%20code/Javascript/Book_University/client/src/pages/user/AddBook.jsx) และหน้าแก้ไขหนังสือ [UpdateABook.jsx](file:///c:/Users/Nontprawitch/Desktop/Vs%20code/Javascript/Book_University/client/src/pages/user/UpdateABook.jsx)
    *   ยกระดับขนาดฟอนต์จาก `text-xs` (12px) ➡️ **`text-sm` (14px)** และ **`text-base` / `text-lg`** สำหรับหัวข้อ ช่องอินพุต ตัวเลือกวิชา คำแนะนำการลงขาย และปุ่มบันทึกข้อมูล

#### 4. Project History Footer & AI Maintenance Acknowledgment (ส่วนท้ายเว็บและเกียรติประวัติโครงงาน)
*   **รายละเอียดฟีเจอร์:**
