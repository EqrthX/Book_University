            ...
            <div className="bg-gradient-to-r from-[#1A365D] to-[#2F5792] text-white py-12 px-6 md:px-12 mb-8 shadow-sm">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-extrabold text-3xl md:text-4xl">แก้ไขรายการหนังสือ</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex flex-col items-center">
                            <h2 className="font-bold text-slate-800 text-base uppercase tracking-wider mb-4 text-left w-full border-b border-slate-100 pb-2">
                            ...
                            <div className="w-full h-80 rounded-2xl bg-slate-50 border border-slate-200 p-4 flex items-center justify-center shadow-inner overflow-hidden">
                                {valuesBook.bookPic ? (
                                    <img 
                                        src={getImageUrl(valuesBook.bookPic)} 
                                    ...
                                    <div className="text-slate-300 flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-sm font-bold">ไม่มีข้อมูลรูปภาพ</span>
                                    </div>
                                )}
                            </div>
                            <span className="text-xs text-slate-400 font-bold text-center mt-3 leading-relaxed">
                            ...
                            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                                ...
                                <div className="md:col-span-12 flex flex-col">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        ...
                                        {/* Delivery options */}
                                        <div className="flex flex-col">
                                            <label className="text-sm font-bold text-slate-700 mb-2">สะดวกนัดรับสินค้าใน ม. หรือไม่ <span className="text-red-500">*</span></label>
                                ...
                                <div className="md:col-span-12 flex flex-col sm:flex-row justify-end items-center gap-3 mt-4 border-t border-slate-100 pt-6">
                                    ...
                                    <button 
                                        type="submit"
                                        className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-[#2F5792] to-[#2B6CB0] border-0 text-white font-bold hover:shadow-lg rounded-xl text-sm transition-all shadow-md cursor-pointer text-center"
                                    >
                                        บันทึกการแก้ไข
                                    </button>
                                </div>
